...
| Metric | Value |
|--------|-------|
| Total items analyzed | 1,043 |
| Days with data       | 103 |
| Historical avg. VADER score | +0.2193 |
| Latest daily report  | [View report](reports/2026-09-12_report.md) |

## Trends Over Time

| Window | Items | Avg. sentiment |
|--------|-------|----------------|
| Last 7 days  | 22  | +0.072  |
| Last 30 days | 152 | +0.028 |
| All-time     | 649 | +0.062 |

**Most-discussed regulatory topics (last 30 days):** **Privacy** (30), **National Security** (18), **Copyright Ip** (17), **Healthcare** (16), **Transparency** (16)

**Stance distribution (last 30 days):** Pro **20%** · Neutral **80%** · Anti **0%**

![Sentiment Timeline](reports/plots/2026-09-12_timeline.png)
![Topics Over Time](reports/plots/2026-09-12_topics_over_time.png)
![Stance Over Time](reports/plots/2026-09-12_stance_over_time.png)
...
---
_Updated automatically on 2026-09-12 13:55 UTC by GitHub Actions._
