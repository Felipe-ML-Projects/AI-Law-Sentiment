...
| Metric | Value |
|--------|-------|
| Total items analyzed | 895 |
| Days with data       | 75 |
| Historical avg. VADER score | +0.2528 |
| Latest daily report  | [View report](reports/2026-08-13_report.md) |

## Trends Over Time

| Window | Items | Avg. sentiment |
|--------|-------|----------------|
| Last 7 days  | 33  | +0.246  |
| Last 30 days | 205 | +0.094 |
| All-time     | 501 | +0.076 |

**Most-discussed regulatory topics (last 30 days):** **Transparency** (36), **Privacy** (35), **Copyright Ip** (26), **Us Legislation** (24), **Bias Fairness** (17)

**Stance distribution (last 30 days):** Pro **27%** · Neutral **73%** · Anti **0%**

![Sentiment Timeline](reports/plots/2026-08-13_timeline.png)
![Topics Over Time](reports/plots/2026-08-13_topics_over_time.png)
![Stance Over Time](reports/plots/2026-08-13_stance_over_time.png)
...
---
_Updated automatically on 2026-08-13 11:48 UTC by GitHub Actions._
